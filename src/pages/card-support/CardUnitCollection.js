...
export default class CardUnitCollection extends Component {
    ...
    render() {
        ...
        return (
            <>
                <ContentHeader title="Pending Customer Card Collection" />
    ...
    getPendingCardRequests = async (auth) => {
        const resp = await cardService.getPendingCardRequests(
            "initiator2",
            auth.branch,
            'CMP'
        );
